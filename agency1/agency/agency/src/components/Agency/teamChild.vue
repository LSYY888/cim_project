			...
			<ul v-if='agentShow'>
				<li class='clearfix' v-for='(teamData, index) in teamData'>
					...
					<div class='right-section'>
						<div v-if='teamData.pass === true ? true : false' class="phone">
...
<script>
	...
	export default {
      ...
      directives: {
       ...
       created () {
        ...
        var url = this.$api.wxUrl + 'api/team/list?page=' + 1 + '&sn=' + sn
  ...
  .right-section div{
   ...
   .client-error{position: absolute; top: 1.4rem; width: 100%; background: #f5f5f5; min-height: 100%}
